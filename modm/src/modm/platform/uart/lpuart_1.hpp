...
#ifndef MODM_STM32_LPUART_1_HPP
#define MODM_STM32_LPUART_1_HPP
#include <modm/architecture/interface/uart.hpp>
#include <modm/platform/gpio/connector.hpp>
#include "uart_base.hpp"
#include "lpuart_hal_1.hpp"
 ...
 */
class Lpuart1 : public UartBase, public ::modm::Uart
{
public:
	using Hal = LpuartHal1;
...
public:
	...
	{
		using Connector = GpioConnector<Peripheral::Lpuart1, Signals...>;
		...
		static_assert(((Connector::template IsValid<Tx> and Connector::template IsValid<Rx>) and sizeof...(Signals) == 2) or
					  ...
					  "Lpuart1::connect() requires one Tx and/or one Rx signal!");
	...
	{
		LpuartHal1::initialize<SystemClock, baudrate, tolerance>(parity, length);
		LpuartHal1::setTransmitterEnable(true);
		LpuartHal1::setReceiverEnable(true);
