 ...
 * @ingroup		modm_platform_uart modm_platform_uart_5
 */
...
public:
	...
	{
		using Connector = GpioConnector<Peripheral::Uart5, Signals...>;
		...
		static_assert(((Connector::template IsValid<Tx> and Connector::template IsValid<Rx>) and sizeof...(Signals) == 2) or
					  ...
					  "Uart5::connect() requires one Tx and/or one Rx signal!");
