...
// ----------------------------------------------------------------------------
void
modm::platform::Timer11::clockEnable()
{
	enable();
}

void
modm::platform::Timer11::enable()
{
	Rcc::enable<Peripheral::Tim11>();
}

void
modm::platform::Timer11::disable()
{
	TIM11->CR1 = 0;
	TIM11->DIER = 0;
	TIM11->CCER = 0;

	Rcc::disable<Peripheral::Tim11>();
}

// ----------------------------------------------------------------------------
void
modm::platform::Timer11::setMode(Mode mode, SlaveMode slaveMode,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer11::configureInputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer11::configureOutputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer11::enableInterruptVector(bool enable, uint32_t priority)
{
	if (enable)
	{
