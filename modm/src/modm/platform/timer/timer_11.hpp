...
#ifndef MODM_STM32_TIMER_11_HPP
#define MODM_STM32_TIMER_11_HPP
...
public:
	...
	connect()
	{
		using Connector = GpioConnector<Peripheral::Tim11, Signals...>;
		Connector::connect();
	}
	...
	setPeriod(uint32_t microseconds, bool autoApply = true)
	{
		...
		// unequal to zero)
		uint32_t cycles = microseconds * (SystemClock::Timer11 / 1'000'000UL);
