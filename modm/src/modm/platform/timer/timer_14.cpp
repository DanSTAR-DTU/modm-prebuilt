...
// ----------------------------------------------------------------------------
void
modm::platform::Timer14::clockEnable()
{
	enable();
}

void
modm::platform::Timer14::enable()
{
	Rcc::enable<Peripheral::Tim14>();
}

void
modm::platform::Timer14::disable()
{
	TIM14->CR1 = 0;
	TIM14->DIER = 0;
	TIM14->CCER = 0;

	Rcc::disable<Peripheral::Tim14>();
}

// ----------------------------------------------------------------------------
void
modm::platform::Timer14::setMode(Mode mode, SlaveMode slaveMode,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer14::configureInputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer14::configureOutputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer14::enableInterruptVector(bool enable, uint32_t priority)
{
	if (enable)
	{
