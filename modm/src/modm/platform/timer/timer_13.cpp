...
// ----------------------------------------------------------------------------
void
modm::platform::Timer13::clockEnable()
{
	enable();
}

void
modm::platform::Timer13::enable()
{
	Rcc::enable<Peripheral::Tim13>();
}

void
modm::platform::Timer13::disable()
{
	TIM13->CR1 = 0;
	TIM13->DIER = 0;
	TIM13->CCER = 0;

	Rcc::disable<Peripheral::Tim13>();
}

// ----------------------------------------------------------------------------
void
modm::platform::Timer13::setMode(Mode mode, SlaveMode slaveMode,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer13::configureInputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer13::configureOutputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer13::enableInterruptVector(bool enable, uint32_t priority)
{
	if (enable)
	{
