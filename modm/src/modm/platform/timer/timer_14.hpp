...
#ifndef MODM_STM32_TIMER_14_HPP
#define MODM_STM32_TIMER_14_HPP
...
public:
	...
	connect()
	{
		using Connector = GpioConnector<Peripheral::Tim14, Signals...>;
		Connector::connect();
	}
	...
	setPeriod(uint32_t microseconds, bool autoApply = true)
	{
		...
		// unequal to zero)
		uint32_t cycles = microseconds * (SystemClock::Timer14 / 1'000'000UL);
