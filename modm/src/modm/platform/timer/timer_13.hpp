...
#ifndef MODM_STM32_TIMER_13_HPP
#define MODM_STM32_TIMER_13_HPP
...
public:
	...
	connect()
	{
		using Connector = GpioConnector<Peripheral::Tim13, Signals...>;
		Connector::connect();
	}
	...
	setPeriod(uint32_t microseconds, bool autoApply = true)
	{
		...
		// unequal to zero)
		uint32_t cycles = microseconds * (SystemClock::Timer13 / 1'000'000UL);
