...
#ifndef MODM_STM32_GPIO_PIN_I14_HPP
#define MODM_STM32_GPIO_PIN_I14_HPP
...
/// @cond
class GpioI14;
using GpioOutputI14 = GpioI14;
using GpioInputI14  = GpioI14;
/// @endcond

/// IO class for Pin I14
/// @ingroup	modm_platform_gpio
class GpioI14 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI14>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI14;
	using Input = GpioI14;
	using IO = GpioI14;
	using Type = GpioI14;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI14::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Clk { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioI14::Clk only connects to Ltdc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI14::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI14;
...
template<>
struct GpioI14::Clk<Peripheral::Ltdc>
{
	using Gpio = GpioI14;
...
#endif // MODM_STM32_GPIO_PIN_I14_HPP