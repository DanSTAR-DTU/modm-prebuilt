...
public:
	...
	struct Bk1io1 { static void connect();
		static_assert(
			...
			"GpioB0::Bk1io1 only connects to Quadspi1!");
	};
	template< Peripheral peripheral >
	...
	struct Inp { static void connect();
		static_assert(
			...
			"GpioB0::Inp only connects to Comp4!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB0::Bk1io1<Peripheral::Quadspi1>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Flt5<Peripheral::Hrtim1>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Frstx1<Peripheral::Ucpd1>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Frstx2<Peripheral::Ucpd1>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::In12<Peripheral::Adc3>
{
	using Gpio = GpioB0;
...
template<>
constexpr int8_t
GpioB0::AdcChannel<Peripheral::Adc3> = 12;
template<>
...
template<>
struct GpioB0::Inp<Peripheral::Comp4>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Vinp<Peripheral::Opamp2>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Vinp<Peripheral::Opamp3>
{
	using Gpio = GpioB0;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Vinp;
	static constexpr int af = -1;
...
template<>
struct GpioB0::Vinpsec<Peripheral::Opamp2>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Vinpsec<Peripheral::Opamp3>
{
	using Gpio = GpioB0;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Vinpsec;
	static constexpr int af = -1;
