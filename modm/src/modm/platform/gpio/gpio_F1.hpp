...
public:
	...
	struct Sck { static void connect();
		static_assert(
			...
			"GpioF1::Sck only connects to Spi2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioF1::Ck<Peripheral::I2s2>
{
	using Gpio = GpioF1;
...
template<>
struct GpioF1::In10<Peripheral::Adc2>
{
	using Gpio = GpioF1;
...
template<>
constexpr int8_t
GpioF1::AdcChannel<Peripheral::Adc2> = 10;
template<>
struct GpioF1::Inm<Peripheral::Comp3>
{
	using Gpio = GpioF1;
...
template<>
struct GpioF1::Sck<Peripheral::Spi2>
{
	using Gpio = GpioF1;
