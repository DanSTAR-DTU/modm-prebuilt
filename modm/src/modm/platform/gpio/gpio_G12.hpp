...
public:
	...
	struct B1 { static void connect();
		static_assert(
			...
			"GpioG12::B1 only connects to Ltdc!");
	};
	template< Peripheral peripheral >
	struct B4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioG12::B4 only connects to Ltdc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioG12::B1<Peripheral::Ltdc>
{
	using Gpio = GpioG12;
...
template<>
struct GpioG12::B4<Peripheral::Ltdc>
{
	using Gpio = GpioG12;
...
template<>
struct GpioG12::In1<Peripheral::Spdifrx>
{
	using Gpio = GpioG12;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In1;
