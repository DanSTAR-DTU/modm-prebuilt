...
public:
	...
	struct Bk2Io1 { static void connect();
		static_assert(
			...
			"GpioH3::Bk2Io1 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	...
	struct MclkB { static void connect();
		static_assert(
			...
			"GpioH3::MclkB only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct R1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioH3::R1 only connects to Ltdc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioH3::Bk2Io1<Peripheral::Quadspi>
{
	using Gpio = GpioH3;
...
template<>
struct GpioH3::MclkB<Peripheral::Sai2>
{
	using Gpio = GpioH3;
...
template<>
struct GpioH3::R1<Peripheral::Ltdc>
{
	using Gpio = GpioH3;
