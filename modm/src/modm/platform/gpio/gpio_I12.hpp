...
#ifndef MODM_STM32_GPIO_PIN_I12_HPP
#define MODM_STM32_GPIO_PIN_I12_HPP
...
/// @cond
class GpioI12;
using GpioOutputI12 = GpioI12;
using GpioInputI12  = GpioI12;
/// @endcond

/// IO class for Pin I12
/// @ingroup	modm_platform_gpio
class GpioI12 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI12>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI12;
	using Input = GpioI12;
	using IO = GpioI12;
	using Type = GpioI12;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI12::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Hsync { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioI12::Hsync only connects to Ltdc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI12::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI12;
...
template<>
struct GpioI12::Hsync<Peripheral::Ltdc>
{
	using Gpio = GpioI12;
...
#endif // MODM_STM32_GPIO_PIN_I12_HPP