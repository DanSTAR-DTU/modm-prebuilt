...
public:
	...
	struct Ch1 { static void connect();
		static_assert(
			...
			"GpioA11::Ch1 only connects to Tim4!");
	};
	template< Peripheral peripheral >
	struct Ch1n { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioA11::Ch1n only connects to Tim1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Chb2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Hrtim1),
			"GpioA11::Chb2 only connects to Hrtim1!");
	};
	template< Peripheral peripheral >
	...
	struct Mosi { static void connect();
		static_assert(
			...
			"GpioA11::Mosi only connects to Spi2!");
	};
	template< Peripheral peripheral >
	struct Nss { static void connect();
		static_assert(
			(peripheral == Peripheral::Usart1),
			"GpioA11::Nss only connects to Usart1!");
	};
	template< Peripheral peripheral >
	...
	struct Rx { static void connect();
		static_assert(
			(peripheral == Peripheral::Fdcan1),
			"GpioA11::Rx only connects to Fdcan1!");
	};
	template< Peripheral peripheral >
	struct Sd { static void connect();
		static_assert(
			(peripheral == Peripheral::I2s2),
			"GpioA11::Sd only connects to I2s2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA11::Ch1<Peripheral::Tim4>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Ch1n<Peripheral::Tim1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Chb2<Peripheral::Hrtim1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Mosi<Peripheral::Spi2>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Nss<Peripheral::Usart1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Rx<Peripheral::Fdcan1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Sd<Peripheral::I2s2>
{
	using Gpio = GpioA11;
