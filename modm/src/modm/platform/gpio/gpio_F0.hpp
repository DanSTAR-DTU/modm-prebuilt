...
public:
	...
	struct Ws { static void connect();
		static_assert(
			...
			"GpioF0::Ws only connects to I2s2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioF0::Ch3n<Peripheral::Tim1>
{
	using Gpio = GpioF0;
...
template<>
struct GpioF0::In10<Peripheral::Adc1>
{
	using Gpio = GpioF0;
...
template<>
constexpr int8_t
GpioF0::AdcChannel<Peripheral::Adc1> = 10;
template<>
struct GpioF0::Nss<Peripheral::Spi2>
{
	using Gpio = GpioF0;
...
template<>
struct GpioF0::Ws<Peripheral::I2s2>
{
	using Gpio = GpioF0;
