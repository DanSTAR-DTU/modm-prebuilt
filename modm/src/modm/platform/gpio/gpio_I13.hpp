...
#ifndef MODM_STM32_GPIO_PIN_I13_HPP
#define MODM_STM32_GPIO_PIN_I13_HPP
...
/// @cond
class GpioI13;
using GpioOutputI13 = GpioI13;
using GpioInputI13  = GpioI13;
/// @endcond

/// IO class for Pin I13
/// @ingroup	modm_platform_gpio
class GpioI13 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI13>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI13;
	using Input = GpioI13;
	using IO = GpioI13;
	using Type = GpioI13;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI13::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Vsync { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioI13::Vsync only connects to Ltdc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI13::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI13;
...
template<>
struct GpioI13::Vsync<Peripheral::Ltdc>
{
	using Gpio = GpioI13;
...
#endif // MODM_STM32_GPIO_PIN_I13_HPP