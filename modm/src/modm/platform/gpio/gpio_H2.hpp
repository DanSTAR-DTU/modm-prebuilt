...
public:
	...
	struct Bk2Io0 { static void connect();
		static_assert(
			...
			"GpioH2::Bk2Io0 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioH2::Bk2Io0<Peripheral::Quadspi>
{
	using Gpio = GpioH2;
...
template<>
struct GpioH2::In2<Peripheral::Lptim1>
{
	using Gpio = GpioH2;
...
template<>
struct GpioH2::R0<Peripheral::Ltdc>
{
	using Gpio = GpioH2;
...
template<>
struct GpioH2::SckB<Peripheral::Sai2>
{
	using Gpio = GpioH2;
