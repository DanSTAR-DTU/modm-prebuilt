...
protected:
	static constexpr int8_t shift_masks[11][width] = {
		...
		{(Gpios::port == Set::Port::J ? Gpios::pin : -1)...},
		{(Gpios::port == Set::Port::K ? Gpios::pin : -1)...},
	};
...
public:
	static PortType isSet()
	{
		...
		if constexpr (mask(9)) {
			const uint16_t p = (GPIOJ->ODR & mask(9)) ^ inverted(9);
			if constexpr (0 < width) if constexpr (constexpr auto pos = shift_mask(9, 0); pos >= 0) r |= ((p >> pos) & 1) << 0;
			if constexpr (1 < width) if constexpr (constexpr auto pos = shift_mask(9, 1); pos >= 0) r |= ((p >> pos) & 1) << 1;
			if constexpr (2 < width) if constexpr (constexpr auto pos = shift_mask(9, 2); pos >= 0) r |= ((p >> pos) & 1) << 2;
			if constexpr (3 < width) if constexpr (constexpr auto pos = shift_mask(9, 3); pos >= 0) r |= ((p >> pos) & 1) << 3;
			if constexpr (4 < width) if constexpr (constexpr auto pos = shift_mask(9, 4); pos >= 0) r |= ((p >> pos) & 1) << 4;
			if constexpr (5 < width) if constexpr (constexpr auto pos = shift_mask(9, 5); pos >= 0) r |= ((p >> pos) & 1) << 5;
			if constexpr (6 < width) if constexpr (constexpr auto pos = shift_mask(9, 6); pos >= 0) r |= ((p >> pos) & 1) << 6;
			if constexpr (7 < width) if constexpr (constexpr auto pos = shift_mask(9, 7); pos >= 0) r |= ((p >> pos) & 1) << 7;
			if constexpr (8 < width) if constexpr (constexpr auto pos = shift_mask(9, 8); pos >= 0) r |= ((p >> pos) & 1) << 8;
			if constexpr (9 < width) if constexpr (constexpr auto pos = shift_mask(9, 9); pos >= 0) r |= ((p >> pos) & 1) << 9;
			if constexpr (10 < width) if constexpr (constexpr auto pos = shift_mask(9, 10); pos >= 0) r |= ((p >> pos) & 1) << 10;
			if constexpr (11 < width) if constexpr (constexpr auto pos = shift_mask(9, 11); pos >= 0) r |= ((p >> pos) & 1) << 11;
			if constexpr (12 < width) if constexpr (constexpr auto pos = shift_mask(9, 12); pos >= 0) r |= ((p >> pos) & 1) << 12;
			if constexpr (13 < width) if constexpr (constexpr auto pos = shift_mask(9, 13); pos >= 0) r |= ((p >> pos) & 1) << 13;
			if constexpr (14 < width) if constexpr (constexpr auto pos = shift_mask(9, 14); pos >= 0) r |= ((p >> pos) & 1) << 14;
			if constexpr (15 < width) if constexpr (constexpr auto pos = shift_mask(9, 15); pos >= 0) r |= ((p >> pos) & 1) << 15;
			if constexpr (16 < width) if constexpr (constexpr auto pos = shift_mask(9, 16); pos >= 0) r |= ((p >> pos) & 1) << 16;
			if constexpr (17 < width) if constexpr (constexpr auto pos = shift_mask(9, 17); pos >= 0) r |= ((p >> pos) & 1) << 17;
			if constexpr (18 < width) if constexpr (constexpr auto pos = shift_mask(9, 18); pos >= 0) r |= ((p >> pos) & 1) << 18;
			if constexpr (19 < width) if constexpr (constexpr auto pos = shift_mask(9, 19); pos >= 0) r |= ((p >> pos) & 1) << 19;
			if constexpr (20 < width) if constexpr (constexpr auto pos = shift_mask(9, 20); pos >= 0) r |= ((p >> pos) & 1) << 20;
			if constexpr (21 < width) if constexpr (constexpr auto pos = shift_mask(9, 21); pos >= 0) r |= ((p >> pos) & 1) << 21;
			if constexpr (22 < width) if constexpr (constexpr auto pos = shift_mask(9, 22); pos >= 0) r |= ((p >> pos) & 1) << 22;
			if constexpr (23 < width) if constexpr (constexpr auto pos = shift_mask(9, 23); pos >= 0) r |= ((p >> pos) & 1) << 23;
			if constexpr (24 < width) if constexpr (constexpr auto pos = shift_mask(9, 24); pos >= 0) r |= ((p >> pos) & 1) << 24;
			if constexpr (25 < width) if constexpr (constexpr auto pos = shift_mask(9, 25); pos >= 0) r |= ((p >> pos) & 1) << 25;
			if constexpr (26 < width) if constexpr (constexpr auto pos = shift_mask(9, 26); pos >= 0) r |= ((p >> pos) & 1) << 26;
			if constexpr (27 < width) if constexpr (constexpr auto pos = shift_mask(9, 27); pos >= 0) r |= ((p >> pos) & 1) << 27;
			if constexpr (28 < width) if constexpr (constexpr auto pos = shift_mask(9, 28); pos >= 0) r |= ((p >> pos) & 1) << 28;
			if constexpr (29 < width) if constexpr (constexpr auto pos = shift_mask(9, 29); pos >= 0) r |= ((p >> pos) & 1) << 29;
			if constexpr (30 < width) if constexpr (constexpr auto pos = shift_mask(9, 30); pos >= 0) r |= ((p >> pos) & 1) << 30;
			if constexpr (31 < width) if constexpr (constexpr auto pos = shift_mask(9, 31); pos >= 0) r |= ((p >> pos) & 1) << 31;
		}
		if constexpr (mask(10)) {
			const uint16_t p = (GPIOK->ODR & mask(10)) ^ inverted(10);
			if constexpr (0 < width) if constexpr (constexpr auto pos = shift_mask(10, 0); pos >= 0) r |= ((p >> pos) & 1) << 0;
			if constexpr (1 < width) if constexpr (constexpr auto pos = shift_mask(10, 1); pos >= 0) r |= ((p >> pos) & 1) << 1;
			if constexpr (2 < width) if constexpr (constexpr auto pos = shift_mask(10, 2); pos >= 0) r |= ((p >> pos) & 1) << 2;
			if constexpr (3 < width) if constexpr (constexpr auto pos = shift_mask(10, 3); pos >= 0) r |= ((p >> pos) & 1) << 3;
			if constexpr (4 < width) if constexpr (constexpr auto pos = shift_mask(10, 4); pos >= 0) r |= ((p >> pos) & 1) << 4;
			if constexpr (5 < width) if constexpr (constexpr auto pos = shift_mask(10, 5); pos >= 0) r |= ((p >> pos) & 1) << 5;
			if constexpr (6 < width) if constexpr (constexpr auto pos = shift_mask(10, 6); pos >= 0) r |= ((p >> pos) & 1) << 6;
			if constexpr (7 < width) if constexpr (constexpr auto pos = shift_mask(10, 7); pos >= 0) r |= ((p >> pos) & 1) << 7;
			if constexpr (8 < width) if constexpr (constexpr auto pos = shift_mask(10, 8); pos >= 0) r |= ((p >> pos) & 1) << 8;
			if constexpr (9 < width) if constexpr (constexpr auto pos = shift_mask(10, 9); pos >= 0) r |= ((p >> pos) & 1) << 9;
			if constexpr (10 < width) if constexpr (constexpr auto pos = shift_mask(10, 10); pos >= 0) r |= ((p >> pos) & 1) << 10;
			if constexpr (11 < width) if constexpr (constexpr auto pos = shift_mask(10, 11); pos >= 0) r |= ((p >> pos) & 1) << 11;
			if constexpr (12 < width) if constexpr (constexpr auto pos = shift_mask(10, 12); pos >= 0) r |= ((p >> pos) & 1) << 12;
			if constexpr (13 < width) if constexpr (constexpr auto pos = shift_mask(10, 13); pos >= 0) r |= ((p >> pos) & 1) << 13;
			if constexpr (14 < width) if constexpr (constexpr auto pos = shift_mask(10, 14); pos >= 0) r |= ((p >> pos) & 1) << 14;
			if constexpr (15 < width) if constexpr (constexpr auto pos = shift_mask(10, 15); pos >= 0) r |= ((p >> pos) & 1) << 15;
			if constexpr (16 < width) if constexpr (constexpr auto pos = shift_mask(10, 16); pos >= 0) r |= ((p >> pos) & 1) << 16;
			if constexpr (17 < width) if constexpr (constexpr auto pos = shift_mask(10, 17); pos >= 0) r |= ((p >> pos) & 1) << 17;
			if constexpr (18 < width) if constexpr (constexpr auto pos = shift_mask(10, 18); pos >= 0) r |= ((p >> pos) & 1) << 18;
			if constexpr (19 < width) if constexpr (constexpr auto pos = shift_mask(10, 19); pos >= 0) r |= ((p >> pos) & 1) << 19;
			if constexpr (20 < width) if constexpr (constexpr auto pos = shift_mask(10, 20); pos >= 0) r |= ((p >> pos) & 1) << 20;
			if constexpr (21 < width) if constexpr (constexpr auto pos = shift_mask(10, 21); pos >= 0) r |= ((p >> pos) & 1) << 21;
			if constexpr (22 < width) if constexpr (constexpr auto pos = shift_mask(10, 22); pos >= 0) r |= ((p >> pos) & 1) << 22;
			if constexpr (23 < width) if constexpr (constexpr auto pos = shift_mask(10, 23); pos >= 0) r |= ((p >> pos) & 1) << 23;
			if constexpr (24 < width) if constexpr (constexpr auto pos = shift_mask(10, 24); pos >= 0) r |= ((p >> pos) & 1) << 24;
			if constexpr (25 < width) if constexpr (constexpr auto pos = shift_mask(10, 25); pos >= 0) r |= ((p >> pos) & 1) << 25;
			if constexpr (26 < width) if constexpr (constexpr auto pos = shift_mask(10, 26); pos >= 0) r |= ((p >> pos) & 1) << 26;
			if constexpr (27 < width) if constexpr (constexpr auto pos = shift_mask(10, 27); pos >= 0) r |= ((p >> pos) & 1) << 27;
			if constexpr (28 < width) if constexpr (constexpr auto pos = shift_mask(10, 28); pos >= 0) r |= ((p >> pos) & 1) << 28;
			if constexpr (29 < width) if constexpr (constexpr auto pos = shift_mask(10, 29); pos >= 0) r |= ((p >> pos) & 1) << 29;
			if constexpr (30 < width) if constexpr (constexpr auto pos = shift_mask(10, 30); pos >= 0) r |= ((p >> pos) & 1) << 30;
			if constexpr (31 < width) if constexpr (constexpr auto pos = shift_mask(10, 31); pos >= 0) r |= ((p >> pos) & 1) << 31;
		}
		return r;
	}
	...
	static void write(PortType data)
	{
		...
		if constexpr (mask(9)) { uint32_t p{0};
			if constexpr (0 < width) if constexpr (constexpr auto pos = shift_mask(9, 0); pos >= 0) p |= (data & (1ul << 0)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (1 < width) if constexpr (constexpr auto pos = shift_mask(9, 1); pos >= 0) p |= (data & (1ul << 1)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (2 < width) if constexpr (constexpr auto pos = shift_mask(9, 2); pos >= 0) p |= (data & (1ul << 2)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (3 < width) if constexpr (constexpr auto pos = shift_mask(9, 3); pos >= 0) p |= (data & (1ul << 3)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (4 < width) if constexpr (constexpr auto pos = shift_mask(9, 4); pos >= 0) p |= (data & (1ul << 4)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (5 < width) if constexpr (constexpr auto pos = shift_mask(9, 5); pos >= 0) p |= (data & (1ul << 5)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (6 < width) if constexpr (constexpr auto pos = shift_mask(9, 6); pos >= 0) p |= (data & (1ul << 6)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (7 < width) if constexpr (constexpr auto pos = shift_mask(9, 7); pos >= 0) p |= (data & (1ul << 7)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (8 < width) if constexpr (constexpr auto pos = shift_mask(9, 8); pos >= 0) p |= (data & (1ul << 8)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (9 < width) if constexpr (constexpr auto pos = shift_mask(9, 9); pos >= 0) p |= (data & (1ul << 9)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (10 < width) if constexpr (constexpr auto pos = shift_mask(9, 10); pos >= 0) p |= (data & (1ul << 10)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (11 < width) if constexpr (constexpr auto pos = shift_mask(9, 11); pos >= 0) p |= (data & (1ul << 11)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (12 < width) if constexpr (constexpr auto pos = shift_mask(9, 12); pos >= 0) p |= (data & (1ul << 12)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (13 < width) if constexpr (constexpr auto pos = shift_mask(9, 13); pos >= 0) p |= (data & (1ul << 13)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (14 < width) if constexpr (constexpr auto pos = shift_mask(9, 14); pos >= 0) p |= (data & (1ul << 14)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (15 < width) if constexpr (constexpr auto pos = shift_mask(9, 15); pos >= 0) p |= (data & (1ul << 15)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (16 < width) if constexpr (constexpr auto pos = shift_mask(9, 16); pos >= 0) p |= (data & (1ul << 16)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (17 < width) if constexpr (constexpr auto pos = shift_mask(9, 17); pos >= 0) p |= (data & (1ul << 17)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (18 < width) if constexpr (constexpr auto pos = shift_mask(9, 18); pos >= 0) p |= (data & (1ul << 18)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (19 < width) if constexpr (constexpr auto pos = shift_mask(9, 19); pos >= 0) p |= (data & (1ul << 19)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (20 < width) if constexpr (constexpr auto pos = shift_mask(9, 20); pos >= 0) p |= (data & (1ul << 20)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (21 < width) if constexpr (constexpr auto pos = shift_mask(9, 21); pos >= 0) p |= (data & (1ul << 21)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (22 < width) if constexpr (constexpr auto pos = shift_mask(9, 22); pos >= 0) p |= (data & (1ul << 22)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (23 < width) if constexpr (constexpr auto pos = shift_mask(9, 23); pos >= 0) p |= (data & (1ul << 23)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (24 < width) if constexpr (constexpr auto pos = shift_mask(9, 24); pos >= 0) p |= (data & (1ul << 24)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (25 < width) if constexpr (constexpr auto pos = shift_mask(9, 25); pos >= 0) p |= (data & (1ul << 25)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (26 < width) if constexpr (constexpr auto pos = shift_mask(9, 26); pos >= 0) p |= (data & (1ul << 26)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (27 < width) if constexpr (constexpr auto pos = shift_mask(9, 27); pos >= 0) p |= (data & (1ul << 27)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (28 < width) if constexpr (constexpr auto pos = shift_mask(9, 28); pos >= 0) p |= (data & (1ul << 28)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (29 < width) if constexpr (constexpr auto pos = shift_mask(9, 29); pos >= 0) p |= (data & (1ul << 29)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (30 < width) if constexpr (constexpr auto pos = shift_mask(9, 30); pos >= 0) p |= (data & (1ul << 30)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (31 < width) if constexpr (constexpr auto pos = shift_mask(9, 31); pos >= 0) p |= (data & (1ul << 31)) ? (1ul << pos) : (1ul << (pos + 16));
			p ^= inverted(9);
			GPIOJ->BSRR = ((~p & mask(9)) << 16) | p;
		}
		if constexpr (mask(10)) { uint32_t p{0};
			if constexpr (0 < width) if constexpr (constexpr auto pos = shift_mask(10, 0); pos >= 0) p |= (data & (1ul << 0)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (1 < width) if constexpr (constexpr auto pos = shift_mask(10, 1); pos >= 0) p |= (data & (1ul << 1)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (2 < width) if constexpr (constexpr auto pos = shift_mask(10, 2); pos >= 0) p |= (data & (1ul << 2)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (3 < width) if constexpr (constexpr auto pos = shift_mask(10, 3); pos >= 0) p |= (data & (1ul << 3)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (4 < width) if constexpr (constexpr auto pos = shift_mask(10, 4); pos >= 0) p |= (data & (1ul << 4)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (5 < width) if constexpr (constexpr auto pos = shift_mask(10, 5); pos >= 0) p |= (data & (1ul << 5)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (6 < width) if constexpr (constexpr auto pos = shift_mask(10, 6); pos >= 0) p |= (data & (1ul << 6)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (7 < width) if constexpr (constexpr auto pos = shift_mask(10, 7); pos >= 0) p |= (data & (1ul << 7)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (8 < width) if constexpr (constexpr auto pos = shift_mask(10, 8); pos >= 0) p |= (data & (1ul << 8)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (9 < width) if constexpr (constexpr auto pos = shift_mask(10, 9); pos >= 0) p |= (data & (1ul << 9)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (10 < width) if constexpr (constexpr auto pos = shift_mask(10, 10); pos >= 0) p |= (data & (1ul << 10)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (11 < width) if constexpr (constexpr auto pos = shift_mask(10, 11); pos >= 0) p |= (data & (1ul << 11)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (12 < width) if constexpr (constexpr auto pos = shift_mask(10, 12); pos >= 0) p |= (data & (1ul << 12)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (13 < width) if constexpr (constexpr auto pos = shift_mask(10, 13); pos >= 0) p |= (data & (1ul << 13)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (14 < width) if constexpr (constexpr auto pos = shift_mask(10, 14); pos >= 0) p |= (data & (1ul << 14)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (15 < width) if constexpr (constexpr auto pos = shift_mask(10, 15); pos >= 0) p |= (data & (1ul << 15)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (16 < width) if constexpr (constexpr auto pos = shift_mask(10, 16); pos >= 0) p |= (data & (1ul << 16)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (17 < width) if constexpr (constexpr auto pos = shift_mask(10, 17); pos >= 0) p |= (data & (1ul << 17)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (18 < width) if constexpr (constexpr auto pos = shift_mask(10, 18); pos >= 0) p |= (data & (1ul << 18)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (19 < width) if constexpr (constexpr auto pos = shift_mask(10, 19); pos >= 0) p |= (data & (1ul << 19)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (20 < width) if constexpr (constexpr auto pos = shift_mask(10, 20); pos >= 0) p |= (data & (1ul << 20)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (21 < width) if constexpr (constexpr auto pos = shift_mask(10, 21); pos >= 0) p |= (data & (1ul << 21)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (22 < width) if constexpr (constexpr auto pos = shift_mask(10, 22); pos >= 0) p |= (data & (1ul << 22)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (23 < width) if constexpr (constexpr auto pos = shift_mask(10, 23); pos >= 0) p |= (data & (1ul << 23)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (24 < width) if constexpr (constexpr auto pos = shift_mask(10, 24); pos >= 0) p |= (data & (1ul << 24)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (25 < width) if constexpr (constexpr auto pos = shift_mask(10, 25); pos >= 0) p |= (data & (1ul << 25)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (26 < width) if constexpr (constexpr auto pos = shift_mask(10, 26); pos >= 0) p |= (data & (1ul << 26)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (27 < width) if constexpr (constexpr auto pos = shift_mask(10, 27); pos >= 0) p |= (data & (1ul << 27)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (28 < width) if constexpr (constexpr auto pos = shift_mask(10, 28); pos >= 0) p |= (data & (1ul << 28)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (29 < width) if constexpr (constexpr auto pos = shift_mask(10, 29); pos >= 0) p |= (data & (1ul << 29)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (30 < width) if constexpr (constexpr auto pos = shift_mask(10, 30); pos >= 0) p |= (data & (1ul << 30)) ? (1ul << pos) : (1ul << (pos + 16));
			if constexpr (31 < width) if constexpr (constexpr auto pos = shift_mask(10, 31); pos >= 0) p |= (data & (1ul << 31)) ? (1ul << pos) : (1ul << (pos + 16));
			p ^= inverted(10);
	...
	static PortType read()
	{
		...
		if constexpr (mask(9)) {
			const uint16_t p = (GPIOJ->IDR & mask(9)) ^ inverted(9);
			if constexpr (0 < width) if constexpr (constexpr auto pos = shift_mask(9, 0); pos >= 0) r |= ((p >> pos) & 1) << 0;
			if constexpr (1 < width) if constexpr (constexpr auto pos = shift_mask(9, 1); pos >= 0) r |= ((p >> pos) & 1) << 1;
			if constexpr (2 < width) if constexpr (constexpr auto pos = shift_mask(9, 2); pos >= 0) r |= ((p >> pos) & 1) << 2;
			if constexpr (3 < width) if constexpr (constexpr auto pos = shift_mask(9, 3); pos >= 0) r |= ((p >> pos) & 1) << 3;
