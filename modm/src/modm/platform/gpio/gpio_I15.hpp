...
#ifndef MODM_STM32_GPIO_PIN_I15_HPP
#define MODM_STM32_GPIO_PIN_I15_HPP
...
/// @cond
class GpioI15;
using GpioOutputI15 = GpioI15;
using GpioInputI15  = GpioI15;
/// @endcond

/// IO class for Pin I15
/// @ingroup	modm_platform_gpio
class GpioI15 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI15>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI15;
	using Input = GpioI15;
	using IO = GpioI15;
	using Type = GpioI15;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI15::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct R0 { static void connect();
		static_assert(
			(peripheral == Peripheral::Ltdc),
			"GpioI15::R0 only connects to Ltdc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI15::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI15;
...
template<>
struct GpioI15::R0<Peripheral::Ltdc>
{
	using Gpio = GpioI15;
...
#endif // MODM_STM32_GPIO_PIN_I15_HPP