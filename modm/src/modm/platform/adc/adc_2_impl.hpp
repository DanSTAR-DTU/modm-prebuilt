...
void
modm::platform::Adc2::startConversion(void)
{
...
bool
modm::platform::Adc2::isConversionFinished(void)
{
...
void
modm::platform::Adc2::acknowledgeInterruptFlag(const InterruptFlag_t flags)
{
