...
void
modm::platform::Adc2::setPrescaler(const Prescaler prescaler)
{
	ADC->CCR = (ADC->CCR & ~(0b11 << 17)) | (uint32_t(prescaler) << 17);
}

void
modm::platform::Adc2::enableTemperatureRefVMeasurement()
{
	ADC->CCR |= ADC_CCR_TSVREFE;
}

void
modm::platform::Adc2::disableTemperatureRefVMeasurement()
{
	ADC->CCR &= ~ADC_CCR_TSVREFE;
}
void
modm::platform::Adc2::setLeftAdjustResult()
{
	ADC2->CR2 |= ADC_CR2_ALIGN;
}

void
modm::platform::Adc2::setRightAdjustResult()
{
	ADC2->CR2 &= ~ADC_CR2_ALIGN;
}

bool
modm::platform::Adc2::setChannel(const Channel channel,
...
modm::platform::Adc2::Channel
modm::platform::Adc2::getChannel()
{
	return Channel(ADC2->SQR3 & 0x1f);
}

bool
modm::platform::Adc2::addChannel(const Channel channel,
									const SampleTime sampleTime)
{
	// read channel count
...
void
modm::platform::Adc2::setSampleTime(const Channel channel,
										const SampleTime sampleTime)
{
...
void
modm::platform::Adc2::enableFreeRunningMode()
{
	ADC2->CR2 |= ADC_CR2_CONT;	// set to continuous mode
}

void
modm::platform::Adc2::disableFreeRunningMode()
{
	ADC2->CR2 &= ~ADC_CR2_CONT;		// set to single mode
}

void
modm::platform::Adc2::disable()
{
...
uint16_t
modm::platform::Adc2::readChannel(Channel channel)
{
